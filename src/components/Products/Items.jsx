...
const RecentViewedItems = () => {
    ...
    return (
        <>
			...
			<>
                                                <Link to={product?.auctioned ? `/auctionproduct/${product?.guid}` : `/singleproduct/${product?.guid}`}>
                                                    <img src={product.media.length > 0 ? product.media[0].name : blank} alt={product.media.length > 0 ? product.media[0].name : "blank"} />
                                                </Link>
                                                </>
                                                ) : (
                                                  <>
			...
			<>
                                                    <Link to={product?.auctioned ? `/auctionproduct/${product?.guid}` : `/singleproduct/${product?.guid}`}>
                                                        <h3>{product.name.substring(0, 10)}...</h3>
                                                         $ {product?.auctioned ? product.bids : product.price}
