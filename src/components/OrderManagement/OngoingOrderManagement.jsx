          ...
          <div className="detailed-product-info">
            ...
            <div className='ord-note'>
                <p>{product.note}</p>
                    ...
                    <button className='backbutton-account' onClick={goBack}><img src={Backimage} /> Back</button>
...
const OngoingOrderManagement = ({ detail, setDetail , getProductManagmentOderCount }) => {
  const [selectedOrderId, setSelectedOrderId] = useState(null);
  const [activeOders, setActiveOrders] = useState({ data: [] });
  const [isLoading, setIsLoading] = useState(true);
  ...
  const getActiveOders = () => {
    OrderServices.sellerActiveOrders()
      .then((response) => {
                        ...
                        <li>
                          ...
                          <div className="p-o-m-w-l-r">
                            <div className="p-o-m-w-l-r-w-d">
                              <button onClick={() => { getActiveOdersDetail(data?.order_id) }}>View Details</button>
                            </div>
                          </div>
                        </li>
                      </ul>
                  ...
                  <div className="s-o-m-d-3-r-a">
                    ...
                    {showAction &&
                      <div className="s-o-m-d-3-r-a-o">
                        <ul>
                          <li onClick={() =>{updateOrderStatus(pendingOdrDetail?.id , 3)}}>Completed</li>
                        </ul>
                      </div>
                    }
                  </div>
