...
const RejectedOrderManagement = ({ detail, setDetail, getProductManagmentOderCount }) => {
  ...
  const getRejectedOders = () => {
    OrderServices.sellerRejectedOrders()
      .then((response) => {
      ...
      {isLoading ?
        ...
        (!detail
                      ...
                      <li>
                        ...
                        <div className="p-o-m-w-l-r">
                          <div className="p-o-m-w-l-r-w-d">
                            <button onClick={() => { getRejectedOdersDetail(data?.order_id) }}>View Details</button>
                          </div>
                        </div>
                      </li>
                    </ul>
          ...
          <div className="seller-oder-managment-detail">
            <div className="title"><span onClick={() => { setDetail(false) }}><IoIosArrowBack /></span>Rejected Order Details</div>
            ...
            <div className="s-o-m-d-2">
              ...
              <div className="s-o-m-d-2-1">
                <div className="s-o-m-d-2-1-l">
                  <img style={{ width: "100%" }} src={Location} alt="map" />
              ...
              <div className="s-o-m-d-3-r">
                <div className="s-o-m-d-3-r-a">
                  <div className="s-o-m-d-3-r-a-l">
                    <div className="s-o-m-d-3-r-a-l-w" style={{ justifyContent: 'center' }}>Rejected</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="d-4-3">
                <ul>
                  <li>
                    <ul>
                      <li>Order Total</li>
                      <li>${rejectedOrderDetail?.ordertotal}</li>
                    </ul>
                  </li>
                </ul>
              </div>
